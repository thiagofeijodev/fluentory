  ...
  test('should navigate between flashcards', async ({ page, context }) => {
    ...
    if (hasFlashcards) {
      ...
      if (await nextButton.isEnabled()) {
        ...
        const nextContent = nextCard;
        await expect(nextContent).not.toHaveText(initialContent);
        ...
        const previousContent = previousCard;
        await expect(previousContent).toHaveText(initialContent);
      }
